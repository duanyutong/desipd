...
if mode.lower() == 'calibrate':
    ...
    print("Modes are 'calibrate', 'accuracy', and 'full'")
...
#print('Using log directory: %s ' % logdir)
#print(pc.get_logs_directory())
...
m.n_points_full_calib_T = 17#11#17
m.n_points_full_calib_P = 9#7#9

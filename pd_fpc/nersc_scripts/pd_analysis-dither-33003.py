...
analysis = FPCAnalysis('dither-33003')
#
...
#                         'dark',
#                         bias_name = 'bias')
#analysis.specify_dataset('image sequence', 3784, 3808,
#                         '33003_tel',
#                         bias_name = 'bias',
#                         dark_name = 'dark',
#                         tile_id = '33003',
...
#                         dither_grid = (5, 5),
#                         dither_step = 1.0)
#analysis.specify_dataset('image sequence', 3821, 3845,
#                         '33003_pos',
#                         bias_name = 'bias',
#                         dark_name = 'dark',
#                         tile_id = '33003',
...
#analysis.reduce_image_sequence('33003_tel')
#analysis.reduce_image_sequence('33003_pos')
#analysis.photometry('33003_tel')
#analysis.photometry('33003_pos')
#analysis.dump_dict()

analysis.load_dict()
analysis.plot_dither_2d('33003_tel')
analysis.plot_dither_3d('33003_tel')
analysis.plot_dither_2d('33003_pos')
analysis.plot_dither_3d('33003_pos')

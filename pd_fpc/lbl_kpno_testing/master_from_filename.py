...
datasetID = '20160413'
datesetDir = os.path.join(parentdir, datasetID)
# os.chdir(dir)
# os.listdir(dir)

# filename match patterns
path_pattern_bias  = os.path.join(datesetDir, '*bias*.fit*')
path_pattern_dark  = os.path.join(datesetDir, '*dark*.fit*')
path_pattern_flat  = os.path.join(datesetDir, '*flat*.fit*')
path_pattern_object = os.path.join(datesetDir, '*object*.fit*')
...
# save master images
os.chdir(dir)
if not os.path.exists('master'):	# check and create master folder
	os.makedirs('master')
# save dirctory
savedir = os.path.join(dir, 'master')
# enter master folder
# os.chdir(savedir)
# create hdu objects

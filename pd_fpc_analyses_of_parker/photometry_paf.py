...
#    from astropy.extern.six.moves import StringIO
    from photutils import (detect_threshold, EllipticalAperture, source_properties, properties_table)
...
#             or 'master_normalised.fit' in filenameCombined:
    ...
    print('Saving segmentation and source propdderties to {}...'.format(dir_save))
    try:
